...
/*
 * Vungle's logger
 * if it's set in general settings, It will get called on every log generated by Vungle (internally and externally).
 */
@property (nonatomic, retain) id<VungleSDKLogger> logger;
